...
API_ID = int(getenv("API_ID", "22533231"))
API_HASH = getenv("API_HASH", "9eead01899cc9d459ca8fbf976261bf4")
...
# forced entry
MUST_JOIN = getenv("MUST_JOIN", "ATRIN_MUSIC_TM")
JOIN_GAK = getenv(
    "JOIN_GAK", "True"
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/atrinazizi/ATRIN_MUSIC",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/linkdonitehranasli"
